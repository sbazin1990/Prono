...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 03 Juin 2014 à 00:00
...
CREATE TABLE IF NOT EXISTS `equipes` (
  ...
  `scorer_a` int(11) DEFAULT NULL,
  `equipe_b` varchar(255) NOT NULL,
  `scorer_b` int(11) DEFAULT NULL,
...
INSERT INTO `equipes` (`id_match`, `equipe_a`, `scorer_a`, `equipe_b`, `scorer_b`, `gagnant`, `date_match`) VALUES
(2, 'portugal', NULL, 'allemagne', NULL, NULL, '2014-06-07 13:10:00'),
(3, 'allemange', 1, 'finlande', 2, NULL, '2014-06-07 13:10:00'),
(4, 'croatie', NULL, 'estonie', NULL, NULL, '2014-06-07 13:10:00'),
(5, 'bulgaire', NULL, 'bresil', NULL, NULL, '2014-06-07 13:10:00'),
(6, 'amerique', NULL, 'chine', NULL, NULL, '2014-06-07 13:10:00'),
(1, 'france', NULL, 'espagne', NULL, NULL, '2014-06-07 13:10:00');
...
(1, 'news1', 'au pays des reves'),
(2, 'premiere news', 'yoyooo');
...
--
-- Contenu de la table `score_match`
--

INSERT INTO `score_match` (`id_player`, `id_match`, `score_a`, `score_b`) VALUES
(4, 2, 0, 0),
(2, 4, 1, 2),
(4, 1, 1, 3),
(5, 5, 1, 1),
...
(1, 'pierre77', '123456', 'popo@hot.fr', '', 1400705893),
(1, 'pierre77', '123456', 'popo@hot.fr', '', 1400706093),
(1, 'benni', '123456', 'beni@hotmail.fr', '', 1400706692),
(4, 'paguilar', 'azerty', '', '', 1400709168);
...
CREATE TABLE IF NOT EXISTS `users2` (
  ...
  `tendance` int(11) NOT NULL DEFAULT '0',
  `signup_date` int(10) NOT NULL,
...
INSERT INTO `users2` (`id`, `username`, `password`, `email`, `points`, `tendance`, `signup_date`, `admin`) VALUES
(1, 'pag', 'azerty', '', 0, 0, 1400710112, NULL),
(2, 'pagu', 'azerty', '', 18, -1, 1400710464, 1),
(3, 'kirsten', 'azerty', '', 19, 1, 1401135349, NULL),
(4, 'amandine', 'azerty', '', 9, 0, 1401307110, NULL),
(5, 'stevou', 'azerty', '', 3, 0, 1401497772, NULL);
